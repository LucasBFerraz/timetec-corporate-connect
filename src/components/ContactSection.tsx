      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-timetec-gray mb-6">
            Solicite seu
            <span className="text-timetec-red"> Orçamento</span>
          </h2>
          
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nossa equipe técnica está pronta para apresentar as melhores soluções 
            em telecomunicações para sua empresa. Fale conosco!
          </p>
        </div>
                  ...
                  <div key={index} className="group">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 group-hover:text-timetec-red transition-colors duration-300">
                          {info.content}
                        </p>
                      </div>
                    </a>
